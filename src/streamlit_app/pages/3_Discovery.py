...
def _run_discovery_bg(progress: dict) -> None:
    ...
    try:
        ...
        result = app.run_discovery(progress_callback=on_progress)
...
def render():
    ...
    with col2:
        ...
        if st.button(
            ...
            threading.Thread(target=_run_discovery_bg, args=(progress,), daemon=True).start()
            st.rerun()
