"""Blogspot/Blogger scraper for finding business blogs."""
...
class BlogspotScraper(BaseScraper):
    """Scraper for Blogspot/Blogger hosted sites."""

    SOURCE_NAME = "blogspot"
    BASE_URL = "https://www.blogger.com"

    SELECTORS = {
        "search_url": "https://www.google.com/search?q=site:blogspot.com+{query}",
    ...
    def search(
        ...
        """Search for Blogspot sites matching the query.
        ...
        try:
            ...
            self.logger.error(f"Error searching Blogspot: {e}")
    ...
    def _extract_lead(
        ...
        try:
            ...
            self.logger.error(f"Error extracting Blogspot lead: {e}")
            return None


ScraperRegistry.register(BlogspotScraper)
