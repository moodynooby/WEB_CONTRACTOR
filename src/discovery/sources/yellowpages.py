"""YellowPages India scraper implementation."""
...
class YellowPagesIndiaScraper(BaseScraper):
    ...
    SELECTORS = {
        ...
        "result_card": "div.js-result",
        "business_name": "h2.title a",
        "phone": "span.tel",
        "address": "p.address",
    ...
    def search(
        ...
        """Search YellowPages India for businesses matching query.
        ...
        try:
            ...
            self.logger.error(f"Error searching YellowPages India: {e}")
...
ScraperRegistry.register(YellowPagesIndiaScraper)
