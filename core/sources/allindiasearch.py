"""AllIndiaSearch scraper implementation."""
...
class AllIndiaSearchScraper(BaseScraper):
    """Scraper for AllIndiaSearch (meta-search engine)."""

    SOURCE_NAME = "allindiasearch"
    BASE_URL = "https://www.allindiasearch.com"

    SELECTORS = {
        "search_box": "input#search",
        "result_card": "div.result",
        "business_name": "h3.title a",
        "phone": "span.phone",
        "address": "p.address",
        "website": "a.site-link",
    }
    ...
    def search(
        ...
        """Search AllIndiaSearch for businesses matching query.
        ...
        try:
            ...
            self.log(f"Error searching AllIndiaSearch: {e}", "error")
...
ScraperRegistry.register(AllIndiaSearchScraper)
